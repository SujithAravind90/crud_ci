      ...
      <div class="col-lg-12">
        ...
        <div class="d-flex justify-content-between mb-3">
          ...
          <a href="<?= base_url('post/create') ?>" class="btn btn-success"> <i class="fas fa-plus"></i> Add New Post</a>
					<a href="<?= base_url('login/do_logout') ?>" class="btn btn-danger" onclick="return confirm('Confirn Logout?')"> <i class="fa-solid fa-right-from-bracket" style="color: #ffffff;"></i> Logout</a>
        </div>
